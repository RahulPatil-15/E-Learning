    ...
    <div className="flex h-screen">
      ...
      <div className="bg-gray-800 text-white w-1/4 p-4">
        ...
        <ul className="space-y-4">
          <li><a href="/instructor/profile" className="block py-2">My Profile</a></li>
          <li><a href="/instructor/manage-courses" className="block py-2">Manage Courses</a></li>
          <li><a href="/instructor/settings" className="block py-2">Settings</a></li>
          <li>
